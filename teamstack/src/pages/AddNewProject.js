            ...
            <Tilt className='sub-main-update' style={{padding:'50px'}}>
                    ...
                    <div className='inputs'>
                            ...
                            <div className='second-input'>
                                <input placeholder='Nr of developers' className='fil' onChange={(event) => setPasswordlog(event.target.value) }/>
                            </div>
                            <div className='second-input'>
                                <input placeholder='Nessesary founds' className='fil' onChange={(event) => setPasswordlog(event.target.value) }/>
                            </div>
                            <div className='second-input'>
                                <input placeholder='Estimated founds' className='fil' onChange={(event) => setPasswordlog(event.target.value) }/>
                            </div>
                            <div className='second-input'>
